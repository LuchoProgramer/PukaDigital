    ...
    <div className="fixed bottom-0 left-0 w-full bg-white border-t border-gray-200 p-3 md:hidden z-40 shadow-[0_-4px_10px_rgba(0,0,0,0.1)] pb-safe">
      <div className="flex gap-3">
        ...
        <a
          ...
          className="flex-1 bg-white border border-gray-200 text-puka-red p-3 rounded-sm flex items-center justify-center active:scale-95 transition-transform shadow-md"
          aria-label="WhatsApp"
        >
          <WhatsAppIcon size={28} className="text-puka-red" />
        </a>
      </div>
    </div>
  );
