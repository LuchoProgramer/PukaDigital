...
const LiveDemoSim = () => {
    ...
    return (
        <div className="relative w-full max-w-[800px] mx-auto min-h-[500px] flex items-center justify-center py-10 overflow-hidden">
            {/* Background elements */}
            ...
            <div className={`flex flex-row w-[200%] md:w-full md:justify-center md:gap-20 transition-transform duration-1000 ease-in-out ${step >= 3 ? '-translate-x-1/2 md:translate-x-0' : 'translate-x-0'}`}>
                ...
                <div className="relative group perspective-1000 w-full md:w-auto flex justify-center shrink-0">
