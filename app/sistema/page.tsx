        ...
        <div className="min-h-screen bg-white font-sans text-gray-900 selection:bg-puka-red selection:text-white">
            ...
            <header className="fixed top-0 left-0 w-full z-50 bg-white/90 backdrop-blur-sm border-b border-gray-100">
                <div className="container mx-auto px-6 py-4 flex justify-between items-center">
                    <Link href="/" className="font-display font-black text-xl tracking-tighter hover:opacity-80 transition-opacity">
                        PUKA<span className="text-puka-red">DIGITAL</span>
                    </Link>
                    <nav className="hidden md:flex gap-6 text-sm font-bold text-gray-500">
                        <Link href="/blog" className="hover:text-puka-red transition-colors">Recursos</Link>
                        <Link href="/agencia" className="hover:text-puka-red transition-colors">Servicios Corporativos</Link>
                    </nav>
                </div>
            </header>
            ...
            <section className="py-20 bg-white">
                <div className="container mx-auto px-6 max-w-6xl">
                    ...
                    <div className="grid md:grid-cols-2 gap-8 lg:gap-12">
                        {/* CARD A: Inventario */}
                        <Link href="/inventario" className="group relative overflow-hidden rounded-2xl border border-gray-200 bg-white hover:border-cyan-500 hover:shadow-2xl transition-all duration-300">
                        ...
                        {/* CARD B: Chatbot */}
                        <Link href="/chatbot" className="group relative overflow-hidden rounded-2xl border border-gray-200 bg-white hover:border-purple-500 hover:shadow-2xl transition-all duration-300">
            ...
            <section className="py-24 bg-gray-50 border-t border-gray-200">
                <div className="container mx-auto px-6 max-w-5xl">
                    ...
                    <div className="grid md:grid-cols-3 gap-6">
                        <Link href="/blog" className="bg-white p-6 rounded-lg border border-gray-200 hover:shadow-lg transition-shadow">
