                ...
                <div className="bg-gray-50 dark:bg-gray-800 p-8 md:p-12 rounded-sm shadow-sm border border-gray-100 dark:border-gray-700">
                    ...
                    <div className="prose prose-lg dark:prose-invert max-w-none text-gray-600 dark:text-gray-300 space-y-8">
                        ...
                        <section>
                            ...
                            <p className="mt-4">
                                Esta integraci&oacute;n es provista por <strong>Puka Digital LLC</strong> (Wyoming, USA · EIN: <code>320856610</code>) en cumplimiento con la normativa de privacidad de EE.UU., as&iacute; como la <strong>Ley Org&aacute;nica de Protecci&oacute;n de Datos Personales (LOPDP)</strong> del Ecuador para clientes locales. Para clientes y usuarios ubicados en la Uni&oacute;n Europea o Reino Unido, el tratamiento de datos se realiza conforme a los principios del <strong>Reglamento General de Protecci&oacute;n de Datos (GDPR)</strong>.
                            </p>
                            <p className="mt-4">
                                Los datos personales tratados a trav&eacute;s de esta integraci&oacute;n no son transferidos ni vendidos a terceros con fines comerciales ni de publicidad.
                            </p>
                        </section>
                        ...
                        <section>
                            ...
                            <p className="mt-2">
                                <strong>Razón Social:</strong> Puka Digital LLC<br />
                                <strong>Direcci&oacute;n:</strong> 5830 East 2nd Street, Ste 7000, Casper, Wyoming 82609, USA<br />
