                ...
                <div className="bg-gray-50 dark:bg-gray-800 p-8 md:p-12 rounded-sm shadow-sm border border-gray-100 dark:border-gray-700">
                    ...
                    <div className="prose prose-lg dark:prose-invert max-w-none text-gray-600 dark:text-gray-300 space-y-8">
                        ...
                        <section>
                            ...
                            <p className="mt-4">
                                Estos t&eacute;rminos est&aacute;n regidos por las leyes del Estado de Wyoming, Estados Unidos para servicios provistos por <strong>Puka Digital LLC</strong> (EIN: <code>320856610</code>). Para contrataciones y clientes locales en Ecuador, se emiten facturas electr&oacute;nicas v&aacute;lidas conforme a la normativa del <strong>Servicio de Rentas Internas (SRI)</strong>.
                            </p>
                            <p className="mt-4">
                        ...
                        <div className="mt-12 p-6 bg-puka-red/5 rounded-sm border border-puka-red/10">
                            <p className="text-sm italic text-gray-500">
                                &Uacute;ltima actualizaci&oacute;n: 30 de agosto de 2026. Empresa: Puka Digital LLC. Para dudas legales espec&iacute;ficas sobre esta integraci&oacute;n, cont&aacute;ctanos en <strong>legal@pukadigital.com</strong>
                            </p>
                        </div>
                    </div>
                </div>
