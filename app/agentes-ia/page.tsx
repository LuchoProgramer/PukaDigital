...
import { whatsappAgentsServiceSchema } from '@/lib/schema/services';
...
export default function PukaIAPage() {
  ...
  // Cálculo ROI específico para agente IA
  ...
  const structuredData = whatsappAgentsServiceSchema;
  ...
  return (
    <div className="bg-white dark:bg-puka-black min-h-screen text-puka-black dark:text-white selection:bg-puka-red selection:text-white">
      <SEO
        title="PukaIA - Agente de IA para WhatsApp | PukaDigital Ecuador"
        description="PukaIA automatiza la atención al cliente de tu negocio en WhatsApp con inteligencia artificial. Respuestas 24/7, integración con tu negocio y setup en 24h. Desde $20/mes."
        keywords="pukaia, agente ia whatsapp, chatbot ecuador, inteligencia artificial whatsapp, automatizacion ventas"
      ...
      <section className="relative pt-24 pb-16 md:pt-32 md:pb-32 overflow-hidden bg-[#080808]">
        {/* Subtle color blobs */}
        <div className="absolute top-0 left-0 w-[400px] h-[400px] bg-puka-red/20 blur-[100px] -translate-x-1/2 -translate-y-1/2 rounded-full"></div>
        <div className="absolute bottom-0 right-0 w-[350px] h-[350px] bg-[#7c3aed]/15 blur-[100px] translate-x-1/4 translate-y-1/4 rounded-full"></div>
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-8 md:p-12 mb-8">
              ...
              <h1 className="font-display font-bold text-5xl md:text-7xl mb-6 leading-[1.1] tracking-tight text-white">
                Tu WhatsApp Atendido por <br />
                <span className="text-puka-red inline-block mt-2">PukaIA, 24/7.</span>
              </h1>

              <p className="text-xl md:text-2xl text-gray-300 mb-10 leading-relaxed max-w-2xl mx-auto font-sans">
                No es un contestador automático. Es un <span className="text-white font-bold">agente de inteligencia artificial</span> que entiende, responde y vende sin interrupciones por solo $20/mes.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4 items-center justify-center">
                ...
                >
                  Configurar mi PukaIA
                  <ArrowRight className="group-hover:translate-x-2 transition-transform" />
                </Link>

                <div className="flex flex-col gap-1 text-left items-start px-2">
                  <div className="flex items-center gap-2 text-puka-red font-bold">
                    <span className="flex gap-0.5">
                      <span className="w-2 h-2 bg-puka-red rounded-full"></span>
                      <span className="w-2 h-2 bg-puka-red rounded-full"></span>
                      <span className="w-2 h-2 bg-gray-500 rounded-full"></span>
                    </span>
                    <span className="text-[10px] uppercase tracking-wider text-gray-400">1 cupo disponible para setup inmediato</span>
                  </div>
                  <p className="text-[10px] text-gray-500 uppercase font-bold tracking-widest leading-none">
                    INTEGRACIÓN OFICIAL • SETUP EN 24H • CERO COSTOS POR MENSAJE
                  </p>
                </div>
              </div>
            </div>
      ...
      <section className="py-32 bg-puka-red text-white text-center relative overflow-hidden">
        <div className="container mx-auto px-6 relative z-10">
          ...
          <p className="text-2xl mb-12 font-bold max-w-2xl mx-auto opacity-90 italic">
            PukaIA es el asistente que no descansa, no se queja y responde como un experto de tu empresa.
          </p>
