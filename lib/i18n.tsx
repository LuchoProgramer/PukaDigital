...
const translations = {
  es: {
    ...
    home: {
      ...
      proof_cristina_status: 'Graduada 2 Dic 2025. Alianza Citas Médicas.',
      ...
      proof_cristina_result_4: 'Early Adopter: Nuevo Sistema de Citas Médicas',
      ...
      proof_carla_status: 'Activación de campañas: Enero 2026',
      proof_carla_has: 'Ya tiene: Web + CMS + Google Business + Chatbot IA',
      proof_carla_next: 'Enero: Lanzamiento Google Ads (Pausa por Fin de Año)',
      proof_carla_result: 'Preparando escala para 2026',
      ...
      proof_hotel_status: 'Activación de campañas: Enero 2026',
      proof_hotel_done: 'Entregado: Web optimizada para SEO + Analytics + Landing cafetería + Menú digital + Blog',
      proof_hotel_learning: 'Próximo paso: Activación Google Ads en Enero',
      ...
      why_limit_slot_1: '✅ Cupo 1: Cristina - PodoclinicEC (GRADUADA)',
      ...
      allies_1_status: 'Graduada 2 Dic 2025 (Autogestionada)',
      allies_1_result: '33 conversiones Google Ads. Partner Early Adopter Citas Médicas.',
      allies_2_name: 'Carla Vanesa Tutistar',
      allies_2_business: 'HealppyPets Veterinaria • Quito',
      allies_2_status: 'Inicio de campañas: Enero 2026',
      allies_2_result: 'Web + Chatbot + GB listos. Pausa estratégica por festividades.',
      ...
      allies_3_status: 'Inicio de campañas: Enero 2026',
      allies_3_result: 'Estructura lista. Activación de tráfico en Enero.',
    ...
    products: {
      ...
      chatbot_section_desc: "El asistente virtual tiene costos reales (procesa conversaciones). Nuestro precio es transparente: solo sube si tus ventas suben.",
  ...
  en: {
    ...
    home: {
      ...
      proof_cristina_status: 'Graduated Dec 2, 2025. Medical App Partner.',
      ...
      proof_cristina_result_4: 'Early Adopter: New Medical Appointment System',
      ...
      proof_carla_location: 'Quito, Ecuador',
      proof_carla_status: 'Activating campaigns in January 2026',
      proof_carla_has: 'Already has: Web + CMS + Google Business + AI Chatbot',
      proof_carla_next: 'January: Google Ads Launch (Holiday Pause)',
      proof_carla_result: 'Preparing scale for 2026',
      ...
      proof_hotel_location: 'Loja, Ecuador',
      proof_hotel_status: 'Activating campaigns in January 2026',
      proof_hotel_done: 'Delivered: SEO-optimized web + Analytics + Café landing + Digital menu + Blog',
      proof_hotel_learning: 'Next step: Google Ads Activation in January',
      ...
      why_limit_slot_1: '✅ Slot 1: Cristina - PodoclinicEC (GRADUATED)',
      ...
      allies_1_status: 'Graduated Dec 2, 2025 (Self-managed)',
      allies_1_result: '33 Google Ads conversions. Strategic Partner Medical Appointments.',
      allies_2_name: 'Carla Vanesa Tutistar',
      allies_2_business: 'HealppyPets Veterinary • Quito',
      allies_2_status: 'Starting campaigns: January 2026',
      allies_2_result: 'Web + Chatbot + GB ready. Strategic holiday pause.',
      allies_2_website: 'healppypets.com',
      allies_3_name: 'Eudalia Jadan & Diego Quezada',
      allies_3_business: 'Hotel Eudiq + Cafetería Viviantes • Loja',
      allies_3_status: 'Starting campaigns: January 2026',
      allies_3_result: 'Structure ready. Traffic activation in January.',
      allies_3_website: 'hoteleudiq.com',
    ...
    ledgerxpertz: {
      ...
      catalog_title: 'Personalized Web Catalog',
      catalog_desc: 'We deliver a custom website so your customers can check product availability in real-time. No more constant messages asking for stock; let technology do the heavy lifting.'
    }
  },
  pt: {
    nav: {
