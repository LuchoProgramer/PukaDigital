...
const translations = {
  es: {
    ...
    home: {
      ...
      // TESTIMONIAL SECTION
      testimonial_video_title: '"Ya No Los Necesito (Y Ese Era el Plan)"',
      testimonial_quote: 'Antes pagaba $350/mes a una agencia que ni me contestaba. Con Puka, aprendí a manejar todo en 3 meses. Ahora pago $20 del chatbot y mi consultorio se llena solo.',
      testimonial_author: 'Cristina Muñoz',
      testimonial_role: 'Podóloga, Quito',
      testimonial_result: 'De 0 presencia digital a independiente en 90 días',
      testimonial_cta: 'Ver su caso completo →',
      ...
      proof_title: 'Nuestros Primeros Graduados',
      ...
      why_limit_title: '¿Por Qué Solo 3-5 Empresas por Mes?',
      why_limit_could: 'Podría aceptar 20 clientes este mes y ganar $6,000.',
      ...
      why_limit_no_scale: 'Eso NO escala a 20 clientes. Por eso elegimos calidad sobre cantidad. Por eso eres un aliado, no un número.',
      why_limit_status: 'Estado actual:',
      why_limit_slot_1: 'Cupo 1: Cristina (Graduada Mes 3)',
      why_limit_slot_2: 'Cupo 2: Carla (En Mes 2)',
      why_limit_slot_3: 'Cupo 3: Hotel Loja (Semana 2)',
      why_limit_slot_4: 'Cupo 4: DISPONIBLE',
      why_limit_slot_5: 'Cupo 5: DISPONIBLE',
      why_limit_cta: 'Tomar el último cupo →',
  ...
  en: {
    ...
    home: {
      ...
      // TESTIMONIAL SECTION
      testimonial_video_title: '"I Don\'t Need Them Anymore (And That Was the Plan)"',
      testimonial_quote: 'I used to pay $350/mo to an agency that didn\'t even reply to my emails. With Puka, I learned to manage everything in 3 months. Now I pay $20 for the chatbot and my practice fills itself.',
      testimonial_author: 'Cristina Muñoz',
      testimonial_role: 'Podiatrist, Quito',
      testimonial_result: 'From zero digital presence to independent in 90 days',
      testimonial_cta: 'See her full case →',
      ...
      proof_title: 'Our First Graduates',
      ...
      // WHY ONLY 3 CLIENTS
      why_limit_title: 'Why Only 3-5 Businesses per Month?',
      why_limit_could: 'I could accept 20 clients this month and make $6,000.',
      ...
      why_limit_no_scale: "That does NOT scale to 20 clients. That's why we choose quality over quantity. That's why you're an ally, not a number.",
      why_limit_status: 'Current status:',
      why_limit_slot_1: 'Slot 1: Cristina (Graduated Month 3)',
      why_limit_slot_2: 'Slot 2: Carla (In Month 2)',
      why_limit_slot_3: 'Slot 3: Hotel Loja (Week 2)',
      why_limit_slot_4: 'Slot 4: AVAILABLE',
      why_limit_slot_5: 'Slot 5: AVAILABLE',
      why_limit_cta: 'Take the last slot →',
  ...
  pt: {
    ...
    home: {
      ...
      // TESTIMONIAL SECTION
      testimonial_video_title: '"Não Preciso Mais Deles (E Esse Era o Plano)"',
      testimonial_quote: 'Eu pagava $350/mês para uma agência que nem respondia meus e-mails. Com a Puka, aprendi a gerenciar tudo em 3 meses. Agora pago $20 pelo chatbot e meu consultório se enche sozinho.',
      testimonial_author: 'Cristina Muñoz',
      testimonial_role: 'Podóloga, Quito',
      testimonial_result: 'De zero presença digital a independente em 90 dias',
      testimonial_cta: 'Ver caso completo →',
      ...
      proof_title: 'Nossos Primeiros Graduados',
      ...
      why_limit_title: 'Por Que Só 3-5 Empresas por Mês?',
      why_limit_could: 'Eu poderia aceitar 20 clientes este mês e ganhar $6.000.',
      ...
      why_limit_no_scale: 'Isso NÃO escala para 20 clientes. Por isso escolhemos qualidade sobre quantidade. Por isso você é um aliado, não um número.',
      why_limit_status: 'Status atual:',
      why_limit_slot_1: 'Vaga 1: Cristina (Graduada Mês 3)',
      why_limit_slot_2: 'Vaga 2: Carla (No Mês 2)',
      why_limit_slot_3: 'Vaga 3: Hotel Loja (Semana 2)',
      why_limit_slot_4: 'Vaga 4: DISPONÍVEL',
      why_limit_slot_5: 'Vaga 5: DISPONÍVEL',
      why_limit_cta: 'Pegar a última vaga →',
